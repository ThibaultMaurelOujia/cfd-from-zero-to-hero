/*
    ...
    P.S. Ce code a ete ecrit par quelqu'un qui a refuse de vendre son temps contre une illusion de prestige.
    Il n'est pas optimise pour le marche. Il est optimise pour avoir encore une ame.
*/
