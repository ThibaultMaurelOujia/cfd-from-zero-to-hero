...
//---------------------------------------------------------------------------
void init_kelvin_helmholtz(       // profil symetrique + perturbation sinusoïdale
    ...
    int    kx      = 4)         // mode sinusoïdal en x
{
    ...
    const double rho0 = 1.0;          // densite uniforme de reference
    const double p0   = 1.0;          // pression uniforme
