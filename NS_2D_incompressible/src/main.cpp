...
int main(int argc, char* argv[]) {
    ...
    // #ifdef AMGCL_WITH_OPENMP
    // #  pragma message(">> AMGCL compilé AVEC OpenMP")
    // #else
    // #  pragma message(">> AMGCL compilé SANS OpenMP")
    // #endif
    ...
    // --- Finalisation des paramètres calculés ---
    params.finalize();

    // --- Affichage des paramètres si demandé --- 
